...
/// Consumed by <c>AddAffiantSemanticKernel()</c> (Story 9.3).
///
...
///   5. ReviewGate adapter        — IAutoFunctionInvocationFilter; TODO (Story 9.3, Phase 1, Story 4)
///
...
/// This helper satisfies positions 4 and (when complete) 5.
/// </summary>
public static class AffiantFilterPipeline
{
    ...
    public static IServiceCollection AddAffiantSkFilters(this IServiceCollection services)
    {
        ...
        // Position 5 — TODO (Story 9.3): ReviewGate adapter.
        // Routes write-intent tool calls through the Docket / Evidence Card flow.
        // ReviewGate itself is registered as a scoped service by the host; this line
        // will wrap it as IAutoFunctionInvocationFilter via a thin ReviewGateFilter adapter.
