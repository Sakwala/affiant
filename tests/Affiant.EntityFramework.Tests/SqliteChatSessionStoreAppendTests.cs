...
/// <summary>
/// Area-5 P2a (affiant#27): <see cref="SqliteChatSessionStore.AppendMessagesAsync"/> must add rows
/// without touching what is already durable, continuing the session's ordinal at MAX+1 — never the
/// delete-and-reinsert path <see cref="SqliteChatSessionStore.SaveMessagesAsync"/> uses.
/// </summary>
public sealed class SqliteChatSessionStoreAppendTests : IAsyncLifetime
{
