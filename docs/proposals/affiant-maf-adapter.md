...
- **ComplianceHarness** — `Affiant.Testing.ComplianceHarness`: CI gate asserting Affidavits are substantive (no populated value tagged `ProvenanceSource.Empty`), guarding the "b72c1fa" regression class (2026-04-30: a lossy extraction change kept structural tests green while shipping hollow Affidavits).
