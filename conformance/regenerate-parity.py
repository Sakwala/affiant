...
NOTES = (
    ...
    "restated here. "
    "(1) WHAT THIS RUN IS. It is a run of the default branch at the commit the run log names, "
    "which builds 1.0.0-beta.3.1. That version HAS shipped -- ten NuGet packages, 2026-09-09 -- "
    "and the branch has taken changes since the tag, so this is a reading of the branch rather "
    "than a re-reading of the released artefacts. The five fixtures the rulebook's negative "
